...
from .views import CategoryAPI, LatestProductsAPI, CreateProductAPI,ListCategoryProductsAPI

urlpatterns = [
  path('category/', CategoryAPI.as_view(), name='category_api'),
  path('al-products/', LatestProductsAPI.as_view(), name='latest_products'),
